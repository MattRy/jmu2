...
// add_filter( 'get_search_form', 'jmu_genesis_search_form' );
/**
 ...
 */
function jmu_genesis_search_form() {
	...
	if ( genesis_html5() ) {
		...
		if ( genesis_a11y( 'search-form' ) ) {
			...
			if ( '' == $label )  {
				$label = apply_filters( 'genesis_search_text', __( 'Search this Genesis website', 'genesis' ) );
			}
