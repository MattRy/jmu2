...
class WSM_Featured_Post extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['title'] ) )
			...
			if ( ! empty( $instance['blog_button_text'] ) && ! empty( $instance['blog_button_link'] ) )
			printf(
				'<p class="more-from-blog"><a href="%1$s">%2$s</a></p>',
				esc_html( $instance['blog_button_link'] ),
				esc_html( $instance['blog_button_text'] )
			);
	...
	function update( $new_instance, $old_instance ) {
		...
		$new_instance['blog_button_text'] = strip_tags( $new_instance['blog_button_text'] );
		$new_instance['blog_button_link'] = strip_tags( $new_instance['blog_button_link'] );
		return $new_instance;
	}
	...
	function form( $instance ) {
		...
		<div class="genesis-widget-column genesis-widget-column-right" style="width: 49%;">
			...
			<div class="genesis-widget-column-box">
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'blog_button_text' ); ?>"><?php _e( 'Blog Button Text', 'genesis' ); ?>:</label>
					<input type="text" id="<?php echo $this->get_field_id( 'blog_button_text' ); ?>" name="<?php echo $this->get_field_name( 'blog_button_text' ); ?>" value="<?php echo esc_attr( $instance['blog_button_text'] ); ?>" class="widefat" />
				</p>
				
				<p>
					<label for="<?php echo $this->get_field_id( 'blog_button_link' ); ?>"><?php _e( 'Blog Button Link', 'genesis' ); ?>:</label>
					<input type="text" id="<?php echo $this->get_field_id( 'blog_button_link' ); ?>" name="<?php echo $this->get_field_name( 'blog_button_link' ); ?>" value="<?php echo esc_attr( $instance['blog_button_link'] ); ?>" class="widefat" />
				</p>
